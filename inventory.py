# I got help from my friends Andile, Mpho and Reag.
...
def view_all():
    ...
    try:
        ...
        for lines in shoe_obj:
            ...
            quantity.append(lines.get_quanty())
...
def re_stock():
    ...
    try:
        ...
        for line in restock_list:
            ...
            quantity.append(line.get_quanty())
        ...
        for item in shoe_obj:
            output += (f'{item.get_country()},{item.get_code()},{item.get_product()},{item.get_cost()},{item.get_quanty()}\n')
...
def value_per_item():
    ...
    for line in shoe_obj:
        value = int(line.get_cost()) * int(line.get_quanty())
...
while True:
    ...
    print("3. Restock")
    print("4. Search")
    print("5. View Item Values")
    print("6. View Sale Items")
    print("7. Exit")
    
    # Get choice from user.         
    menu = int(input("Please enter the choice: "))          
